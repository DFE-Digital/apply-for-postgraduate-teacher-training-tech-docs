require "lib/govuk_tech_docs/api_reference/schema_example"

RSpec.describe GovukTechDocs::ApiReference::SchemaExample do
  describe '#as_json' do
    ...
    def generate_example(schema)
      ...
      GovukTechDocs::ApiReference::SchemaExample.new(document.components.schemas.first.last).as_json
    end
  end
end
